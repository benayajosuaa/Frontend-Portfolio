        ...
        <div className="w-full h-screen flex items-center">
          <div className="px-8 md:px-15 xl:px-20 items-center">
            <div className={` flex flex-col gap-y-5 ${montserratFont.className}`}>
              <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light">
                hai!
              </p>
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light">
                I&apos;m <span className="font-normal">Benaya Joshua</span>
              </h1>
      ...
      <div className="w-full items-center justify-center pt-20 pb-20 mb:pt-30 mb:pb-50">
        <div className="flex flex-col md:flex-row px-8  mb:px-10 gap-x-14">
          ...
          <div className="flex justify-center items-center">
            <img
              className="w-90  md:w-[1000px] lg:w-[1500px] xl:w-[2000px] max-w-full h-auto md:ml-10"
              src="/image/ben2.png"
              alt="Portrait of Benaya Joshua"
            />
          </div>
          {/* text */}
          <div className="flex items-center">
            <span
              className={`font-normal text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl ${montserratFont.className}`}
            >
              <ScrollReveal
                baseOpacity={0}
                enableBlur={true}
                ...
                blurStrength={20}
              >
                I'm an Informatics student who believes technology should serve
                people with empathy. I care about building systems that not only
                function well but also make users feel understood and supported.
                For me, compassion isn't separate from logic - it's what gives
